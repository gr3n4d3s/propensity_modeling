...
4. Although both logistic regression and random forest were tested, for the purposes of this walk-through we chose random forests and the model that provided the greatest insight into the data  
...
```
5. Wash, rinse, and repeat.  A good start but a deeper dive into the metrics would undoubtedly yield better results.  
